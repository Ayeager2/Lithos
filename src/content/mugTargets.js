...
export const MUG_TARGETS = {
  ...
  peasant_e2: {
    ...
    xp: 4, alignmentEvil: 1,
    failPenalty: { hp: -3, sanity: -2 },
    flavor: {
  ...
  peasant_e3: {
    ...
    xp: 6, alignmentEvil: 2,
    failPenalty: { hp: -5, sanity: -3 },
    flavor: {
      opener: ["🧑‍🌾 A townsfolk walks the easy step of someone who pays for problems to go away."],
  ...
  woodcutter_e2: {
    ...
    description: "A team of two — axe in one hand, drag-rope in the other. Smells of resin and sweat.",
    loot: [
  ...
  woodcutter_e3: {
    ...
    xp: 7, alignmentEvil: 2,
    failPenalty: { hp: -9, sanity: -2 },
    flavor: {
  ...
  hunter_e2: {
    ...
    xp: 6, alignmentEvil: 1,
    failPenalty: { hp: -8, sanity: -2 },
    flavor: {
  ...
  hunter_e3: {
    ...
    xp: 9, alignmentEvil: 2,
    failPenalty: { hp: -10, sanity: -4 },
    flavor: {
  ...
  farmer_e3: {
    ...
    xp: 8, alignmentEvil: 3,
    failPenalty: { hp: -3, sanity: -8 },
    flavor: {
  ...
  fisherman_e3: {
    ...
    xp: 8, alignmentEvil: 2,
    failPenalty: { hp: -7, sanity: -3 },
    flavor: {
  ...
  miner_e3: {
    ...
    xp: 11, alignmentEvil: 2,
    failPenalty: { hp: -12, sanity: -3 },
    flavor: {
  ...
  smith_e1: {
    id: "smith_e1", name: "Knapper", role: "smith", icon: "⚒️",
    era: 1, difficulty: 0.4,
  ...
  smith_e3: {
    ...
    loot: [
      ...
      { resource: "emberRune", qty: 1, chance: 0.1 },
    ],
    xp: 14, alignmentEvil: 3,
    failPenalty: { hp: -16, sanity: -5 },
    flavor: {
  ...
  merchant_e1: {
    id: "merchant_e1", name: "Drifter", role: "merchant", icon: "🪙",
    era: 1, difficulty: 0.35,
  ...
  merchant_e3: {
    ...
    xp: 13, alignmentEvil: 3,
    failPenalty: { hp: -12, sanity: -5 },
    flavor: {
